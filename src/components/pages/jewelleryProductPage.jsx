  ...
  return (
    <header className="bg-white border-b border-gray-200 px-4 py-3">
      ...
      <nav className="text-xs text-gray-600 mt-1">
        <span>HOME</span> &gt; <span className="text-purple-600">{categoryConfig.breadcrumb}</span>
      </nav>
    </header>
  );
};
...
// Mobile Filter Modal
const MobileFilterModal = ({ isOpen, onClose, categoryConfig, filters, onFilterChange, onClearAll }) => {
        ...
        <div className="p-4">
          {Object.entries(categoryConfig.filters).map(([filterKey, filterConfig]) => (
            <div key={filterKey} className="mb-6">
              <h4 className="font-medium text-sm text-gray-800 mb-3">{filterConfig.label}</h4>
...
const DynamicSidebarFilters = ({ categoryConfig, filters, onFilterChange, onClearAll }) => {
  return (
          ...
          <div className="flex-1">
            ...
            {products.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-16">
                ...
                <h3 className="text-sm font-medium text-gray-700 mb-2">No products found</h3>
