...
//                     <input type="text" className="w-full outline-none" placeholder="" />
//                   </div>
//                 </div>
//                 <div className="w-full md:w-1/2 md:ml-4">
//                   <label className="block text-sm font-medium mb-2">or Buy in Grams</label>
//                   <div className="flex items-center border rounded-lg p-2">
//                     <input type="text" className="w-full outline-none" placeholder="gms" />
//                   </div>
//                 </div>
//               </div>
//               <p className="text-xs text-gray-500 mb-4">Inclusive of 3% GST</p>
//               <button className="w-full bg-gradient-to-r from-[#de57e5] to-[#8863fb] text-white py-2 rounded-lg mb-4">
//                 Proceed to Buy
//               </button>
...
//                 <p className="text-red-500">₹10670.19/gram</p>
//                 <p className="text-xs text-gray-500">(₹10359.41 + 3% GST)</p>
//                 <p className="text-xs text-gray-500">Price valid for 4:46 min</p>
