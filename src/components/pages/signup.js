...
//             <button
//               onClick={openLoginModal}
//               className="w-full bg-red-500 text-white font-semibold py-3 rounded-lg hover:bg-red-600 transition-all duration-200"
//             >
//               Continue to Login
//             </button>
//           </div>
...
//                     value={formData.mobileNumber}
//                     onChange={handleInputChange}
//                     className="flex-1 min-w-0 px-2 py-2 border bg-white border-gray-300 rounded-r-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-xs text-black"
//                     required
//                   />
//                 </div>
//               </div>
...
//                   value={formData.email}
//                   onChange={handleInputChange}
//                   className="w-full px-3 py-3 border bg-white border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-xs text-black"
//                   required
//                 />
//               </div>
...
//                     value={formData.firstName}
//                     onChange={handleInputChange}
//                     className="w-full px-3 py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-xs text-black"
//                     required
//                   />
//                 </div>
//                 <div>
...
//                   By continuing you acknowledge that you are at least 18 years old and have read and agree to SonaSutra's{' '}
//                   <a href="/terms-and-conditions" className="text-red-500 hover:text-red-600 underline">terms and conditions</a>
//                   {' '}&{' '}
//                   <a href="/terms-and-conditions" className="text-red-500 hover:text-red-600 underline">privacy policy</a>.
//                 </p>
//               </div>
...
//                 onClick={handleSubmit}
//                 disabled={loading}
//                 className="w-full bg-red-500 text-white font-semibold py-3 rounded-lg transition-all duration-200 text-xs shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
//               >
//                 {loading ? (
//                   <div className="flex items-center justify-center">
//                     <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
//                 <button
//                   onClick={openLoginModal}
//                   className="text-red-500 text-xs font-medium hover:text-red-600 transition-colors duration-200 ml-1"
//                 >
//                   Login
//                 </button>
//               </div>
