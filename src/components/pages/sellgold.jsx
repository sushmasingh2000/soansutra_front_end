...
const SellGold = () => {
  ...
  const [SellRate, setSellRate] = useState(10670.19); // Price per gram including GST
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-7xl">
          ...
          <div className="w-full hidden md:flex flex-col md:flex-row justify-between items-start">
            <div className="w-full md:w-2/3 p-4">
              <h2 className="text-2xl font-bold mb-4">Sell Gold</h2>
              <div className="flex flex-col md:flex-row items-center mb-4">
                <div className="w-full md:w-1/2 mb-4 md:mb-0">
                  <label className="block text-sm font-medium mb-2">Sell Gold by Amount</label>
                ...
                <div className="w-full md:w-1/2 md:ml-4">
                  <label className="block text-sm font-medium mb-2">or Sell in Grams</label>
                  <div className="flex items-center border rounded-lg p-2">
                    <input 
                      type="text" 
                      className="w-full outline-none" 
              ...
              <div className="flex items-center text-yellow-500 bg-yellow-100 p-2 rounded-lg">
                ...
                <span>The minimum Sell amount to purchase CaratLane eGold is ₹10</span>
              </div>
            </div>
            <div className="w-full md:w-1/3 p-4">
              <div className="mb-4">
                <h3 className="text-lg font-semibold mb-2">Sell Rate</h3>
                <p className="text-red-500">₹{SellRate.toFixed(2)}/gram</p>
                <p className="text-xs text-gray-500">(₹{(SellRate / 1.03).toFixed(2)} + 3% GST)</p>
              ...
              <div className="mb-4">
                ...
                <button className="text-[#de57e5] text-sm mt-2 ml-4">Check Sell History &gt;</button>
              </div>
