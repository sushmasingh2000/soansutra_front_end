      ...
      <div className="w-full bg-white-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-7xl">
          ...
          <div className="w-full hidden md:flex flex-col">
            <h2 className="text-3xl font-bold mb-4 text-purple-900">Sell Gold</h2>
            ...
            <div className="flex flex-row justify-between mt-4">
              ...
              <div className="w-1/5 text-right pr-6">
                <button className="text-purple-500 text-sm">Check Sell History →</button>
              </div>
          ...
          <div className="md:hidden flex flex-col">
            <h2 className="text-2xl font-bold mb-4 text-purple-900">Sell Gold</h2>
            ...
            <div className="bg-white rounded-lg p-4 shadow mb-4">
              ...
              <button className="text-purple-500 text-sm mt-2 ml-4">Check Sell History →</button>
            </div>
          </div>
        </div>
      </div>
