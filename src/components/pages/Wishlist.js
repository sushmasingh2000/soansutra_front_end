...
const WishlistPage = () => {
    ...
    return (
        <>
            <Header />
            <NavigationBar />
            <div className="max-w-7xl mx-auto p-6 my-10 bg-white rounded shadow">
                <h1 className="text-2xl font-semibold mb-6">Your Wishlist</h1>
                    {loading ? (
                        ...
                        wishlist.map((item) => {
                            ...
                            return (
                                <div key={item.product_id} className="flex shadow-2xl shadow-purple-500 justify-between items-center border-b py-4">
