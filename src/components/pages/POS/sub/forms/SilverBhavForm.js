...
export default function SilverBhavForm() {
  ...
  return (
    <div className="max-w-3xl mx-auto !text-black
     bg-[#fbf6f1] border border-gray-400 p-4 rounded-md shadow-sm text-sm">
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-lg font-semibold text-purple-700">SILVER BHAV</h2>
