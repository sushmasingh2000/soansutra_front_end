  ...
  const activeOrders = [
    {
      ...
      products: [
        { name: 'Wireless Headphones', price: 79.99, quantity: 1, image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=80&h=80&fit=crop' },
        { name: 'Phone Case', price: 25.00, quantity: 2, image: 'https://images.unsplash.com/photo-1573844227882-ca69ad4ea99a?w=80&h=80&fit=crop' }
      ],
    ...
    },
    {
      ...
      products: [
        { name: 'Running Shoes', price: 79.99, quantity: 1, image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=80&h=80&fit=crop' }
      ],
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1560472355-536de3962603?w=100&h=100&fit=crop&crop=center',
      products: [
        { name: 'Laptop Stand', price: 149.99, quantity: 1, image: 'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=80&h=80&fit=crop' },
        { name: 'USB Cable', price: 50.00, quantity: 1, image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=80&h=80&fit=crop' }
      ],
      trackingNumber: 'TRK456789123',
      deliveredDate: '2024-08-20',
      paymentMethod: 'PayPal',
      orderNotes: 'Delivered to mailbox'
    }
  ];
        ...
        <div className="bg-white rounded-lg shadow-sm mb-6">
          <div className="flex">
            <button
              ...
              className={`flex-1 px-4 md:px-6 py-4 text-sm md:text-base font-medium rounded-l-lg transition-colors ${
                activeTab === 'myOrders'
            ...
            <button
              ...
              className={`flex-1 px-4 md:px-6 py-4 text-sm md:text-base font-medium rounded-r-lg transition-colors ${
