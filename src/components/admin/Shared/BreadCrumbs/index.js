...
const BreadCrumbs = ({ navItem, navLink, id }) => {
  ...
  return (
    <div className="flex !p-0 items-center gap-1 !shadow-none !overflow-x-hidden breadcrambs bg-white !bg-opacity-20 border border-white border-opacity-30 rounded-lg">
      <div className="flex items-center gap-1 w-[80vw] !overflow-x-hidden breadcrambs border border-white border-opacity-30 rounded-lg p-0.5">
