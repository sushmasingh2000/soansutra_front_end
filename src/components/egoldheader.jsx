...
// const EgoldHeader = () => {
//   const navItems = [
//     { label: 'BUY GOLD', active: false, route: '/buy-gold' },
//     { label: 'SELL GOLD', active: false, route: '/sell-gold' },
//     { label: 'FAQS', active: false, route: '/egold-faqs' },
//     { label: 'EXCHANGE / REDEEM', active: false, route: '/exchange-redeem', badge: 'NEW' },
//   ];
...
//               <button className="text-gray-700 hover:text-purple-600 font-medium text-xs transition-colors duration-200 pb-1">
//                 {item.label}
//               </button>
...
//                 <button className="text-gray-700 bg-gray-100 hover:bg-purple-100 hover:text-purple-600 px-3 py-1.5 rounded-full text-xs font-medium whitespace-nowrap transition-colors duration-200">
//                   {item.label}
//                 </button>
//                 {item.badge && (
