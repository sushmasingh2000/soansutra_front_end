...
//                 value={searchQuery}
//                 onChange={(e) => setSearchQuery(e.target.value)}
//                 className="w-full pl-3 pr-10 py-2 border border-purple-600 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm border-r-0"
//               />
//               <button
...
//                 value={searchQuery}
//                 onChange={(e) => setSearchQuery(e.target.value)}
//                 className="w-full pl-4 pr-12 py-2.5 border border-purple-600 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm border-r-0"
//               />
//               <button
...
//             {/* Sidebar */}
//             <div className="relative w-full bg-white h-full shadow-xl overflow-y-auto">
//               {/* Sidebar Header */}
...
//                 <Link 
//                   to={"/login"}
//                   className="flex items-center space-x-3 w-full px-4 py-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
//                   onClick={() => setIsMobileMenuOpen(false)}
//                 >
//                   <UserIcon className="h-6 w-6" />
...
//                   className="flex items-center justify-center space-x-2 w-full mt-4 py-3 text-purple-600 font-medium hover:bg-purple-50 rounded-lg transition-colors"
//                 >
...
//                     <span className="text-lg font-semibold text-purple-700 px-3">Products & Services</span>
//                     <div className="h-px bg-gradient-to-r from-transparent via-purple-400 to-transparent flex-1"></div>
//                   </div>
//                 </div>
...
//                   {jewelryTypes.map((item, index) => (
//                     <div key={index} className="bg-gray-50 rounded-lg p-2 hover:bg-gray-100 transition-colors cursor-pointer">
...
//                   {showMoreJewellery && moreJewelleryTypes.map((item, index) => (
//                     <div key={index + 4} className="bg-gray-50 rounded-lg p-2 hover:bg-gray-100 transition-colors cursor-pointer">
//                       <div className="flex flex-col items-center text-center space-y-1">
//                         <img
//                           src={item.image}
//                           alt={item.name}
...
//                 <button
//                   onClick={() => setShowMoreJewellery(!showMoreJewellery)}
//                   className="flex items-center justify-center space-x-2 w-full mt-2 py-2 text-purple-600 font-medium text-sm hover:bg-purple-50 rounded-lg transition-colors"
//                 >
//                   <span>{showMoreJewellery ? 'Less Jewellery' : 'More Jewellery'}</span>
//                   <ChevronRightIcon className={`h-3 w-3 transition-transform ${showMoreJewellery ? 'rotate-90' : ''}`} />
//                 </button>
//               </div>
...
//                         <span className="text-xs font-semibold text-gray-800 bg-white/80 px-1.5 py-0.5 rounded">
//                           {category.name}
//                         </span>
//                       </div>
//                     </div>
...
//                     <div 
//                       key={index} 
//                       className="bg-white border border-gray-200 rounded-lg p-2 hover:shadow-lg transition-all duration-300 cursor-pointer"
//                     >
...
//                   <div className="flex items-center justify-between">
//                     <div className="flex-1">
//                       <h3 className="text-sm font-semibold text-purple-700 mb-0.5">abhishek chaurasia</h3>
//                       <p className="text-gray-600 text-xs">freefireprouser456@yahoo.com</p>
//                     </div>
//                     <button className="bg-white text-purple-700 px-3 py-1.5 rounded-lg text-sm font-medium hover:bg-purple-50 transition-colors">
//                       LOGOUT
//                     </button>
//                   </div>
//                 </div>
