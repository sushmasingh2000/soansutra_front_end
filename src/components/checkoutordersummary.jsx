...
//         <p className="text-xs text-gray-600">Size: {size} Qty: {qty}</p>
//         <div className="flex items-center mt-1">
//           <p className="font-bold text-sm">₹{price.toLocaleString('en-IN')}</p>
//           {originalPrice && (
...
//   if (!products.length) {
//     // Mock demo products for testing, including many to check scrolling
//     products = [
//       {
...
//         price: 26000,
//       },
//       // Add more if needed for extra scrolling
//     ];
//   }
...
//   return (
//     <div className="w-full md:w-[500px] md:ml-auto md:sticky md:top-4 bg-purple-50  shadow-md overflow-hidden md:min-h-[calc(100vh)]">
//       {/* Toggle bar for mobile */}
//       <div
//         className="md:hidden flex justify-between items-center bg-purple-50 p-4 cursor-pointer text-sm font-medium"
...
//         </div>
//         <p className="font-bold">₹{total.toLocaleString('en-IN')}</p>
//       </div>

//       {/* Desktop title */}
//       <h2 className="hidden md:block text-lg font-bold p-4 border-b border-gray-200">Order Summary</h2>
...
//           {/* Delivery info */}
//           <div className="flex items-center text-sm text-purple-600 bg-purple-50 rounded-md p-2 mt-4">
