...
//         <div className="w-full max-w-4xl mx-auto space-y-4">{/* Changed from max-w-2xl to max-w-4xl for wider desktop view */}
...
//                 <div>
//                   <select 
//                     className="w-full px-3 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-600 text-sm"
...
//                   </select>
//                   <p className="text-xs text-blue-500 mt-2">This field is mandatory in case order value exceeds Rs. 2 lacs</p>
//                 </div>
...
//                       className="w-full px-3 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 text-sm placeholder-gray-500"
//                     />
...
//                     {/* Upload Document Button with Options */}
...
//                       Earn 250 xCLusive points. <span className="font-normal">By completing your Personal Details. (1 xCLusive point= ₹1)</span>
//                     </h3>
//                   </div>
...
//                     <div>
//                       <h3 className="text-gray-800 font-medium mb-3 text-sm md:text-base">Let's start with your name*</h3>
...
//                             className="w-full px-3 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 text-sm"
//                           />
//                         </div>
//                         <div>
...
//                     <div>
//                       <h3 className="text-gray-800 font-medium mb-3 text-sm md:text-base">Enter your mobile number*</h3>
//                       <div className="flex">
...
//                           defaultValue="7905140270"
//                           className="flex-1 px-3 py-3 bg-gray-50 border border-gray-200 rounded-r-lg text-gray-700 text-sm"
//                         />
//                       </div>
//                     </div>

//                     <div>
//                       <h3 className="text-gray-800 font-medium mb-1 text-sm md:text-base">Tell us your birth date*</h3>
//                       <p className="text-xs text-gray-600 mb-3">Psst, don't miss out on the special discounts</p>
//                       <input
//                         type="date"
...
//                     <div>
//                       <h3 className="text-gray-800 font-medium mb-1 text-sm md:text-base">Are you a professional?</h3>
//                       <p className="text-xs text-gray-600 mb-3">Tell us more</p>
//                       <select className="w-full px-3 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 text-sm">
//                         <option>Occupation (Optional)</option>
...
//                   <div className="space-y-6">
//                     <div>
//                       <h3 className="text-gray-800 font-medium mb-3 text-sm md:text-base">Select your Gender*</h3>
//                       <div className="grid grid-cols-3 gap-2">
//                         <button className="px-4 py-3 bg-purple-600 text-white rounded-lg text-sm font-medium">
//                           Male
//                         </button>
//                         <button className="px-4 py-3 bg-gray-100 text-gray-700 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200">
//                           Female
//                         </button>
//                         <button className="px-4 py-3 bg-gray-100 text-gray-700 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200">
//                           Other
...
//                     <div>
//                       <h3 className="text-gray-800 font-medium mb-1 text-sm md:text-base">Share your pincode*</h3>
//                       <p className="text-xs text-gray-600 mb-3">This helps us find your product in store</p>
...
//                             defaultValue="201308"
//                             className="w-full pl-10 pr-3 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 text-sm"
//                           />
//                         </div>
...
//                     <div>
//                       <h3 className="text-gray-800 font-medium mb-3 text-sm md:text-base">Email address*</h3>
//                       <div className="flex items-center space-x-2">
//                         <div className="flex-1">
//                           <label className="block text-xs text-gray-600 mb-1">Email ID*</label>
//                           <input
//                             type="email"
//                             defaultValue="firefireprouser456@yahoo.com"
//                             className="w-full px-3 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 text-sm"
//                           />
//                         </div>
...
//                 <div className="pt-4">
//                   <button className="w-full md:w-auto md:min-w-[200px] py-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg text-sm transition-colors">
//                     SAVE & EARN
//                   </button>
//                 </div>
//               </div>
...
const ProfileContent = () => {
  ...
  const handleSaveProfile = () => {
    // Update the main profile data with form data
    setProfileData(prev => ({
      ...prev,
      name: `${prev.firstName} ${prev.lastName}`.trim().toLowerCase()
    }));
    setIsEditing(false);
              ...
              <div className="p-4 md:p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-gray-800 font-medium mb-1 text-sm md:text-base">Anniversary Date</h3>
                      <p className="text-xs text-gray-600 mb-3">Get special offers on your anniversary</p>
                      <input
                        type="date"
                        value={profileData.anniversary}
                        onChange={(e) => setProfileData(prev => ({ ...prev, anniversary: e.target.value }))}
                        className="w-full px-3 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                      />
                    </div>

                    <div>
                      <h3 className="text-gray-800 font-medium mb-1 text-sm md:text-base">Spouse Birthday</h3>
                      <p className="text-xs text-gray-600 mb-3">Never miss celebrating your loved one</p>
                      <input
                        type="date"
                        value={profileData.spouseBirthday}
                        onChange={(e) => setProfileData(prev => ({ ...prev, spouseBirthday: e.target.value }))}
                        className="w-full px-3 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                      />
                    </div>
                  </div>
            ...
            {occasionExpanded && (
              <div className="p-4 md:p-6 space-y-6">
                ...
                <div className="bg-gradient-to-r from-pink-500 to-orange-400 rounded-lg p-4 text-white flex items-center justify-between">
                  <div className="flex-1">
                    <h3 className="font-semibold text-sm md:text-base mb-1">Personalised offers for your occasions!</h3>
                    <p className="text-sm opacity-90">Receive offers 21 days before every occasion you add, without disturbing your celebration!</p>
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-gray-800 font-medium text-sm md:text-base mb-1">Who are you most likely to gift?</h3>
                    <p className="text-xs text-gray-600 mb-3">Your gifting preferences help us suggest better</p>
                  </div>
                  
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                    {['Self', 'Wife', 'Mother', 'Sister', 'Friend', 'Girlfriend', 'Daughter', 'Husband', 'Father', 'Son', 'Niece/ Nephew', 'Grandparent', 'Others'].map((person) => (
                      <button
                        key={person}
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-gray-800 font-medium text-sm md:text-base mb-1">Tell us which dates are important for you?</h3>
                    <p className="text-xs text-gray-600 mb-3">And we'll make them extra special</p>
                  </div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setOccasionData(prev => ({ ...prev, occasionDate: e.target.value }))}
                      className="w-full px-3 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-gray-800 font-medium text-sm md:text-base mb-1">Are you celebrating an occasion?</h3>
                    <p className="text-xs text-gray-600 mb-3">Don't worry we'll keep it private too!</p>
                  </div>
  ...
  return (
    <div className="p-3 md:p-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="divide-y divide-gray-200">
          {[
            { label: 'NAME', value: profileData.name || `${profileData.firstName} ${profileData.lastName}`.trim() },
            { label: 'EMAIL', value: profileData.email },
            { label: 'MOBILE NO.', value: profileData.mobile },
            { label: 'PINCODE', value: profileData.pincode },
            { label: 'BIRTHDAY', value: profileData.birthday || '-' },
