...
const CertificateVerification = () => {
  ...
  <h1 className="text-4xl font-bold ">CERTIFICATION</h1> {/* mb-8 → mb-4 */}
  <h1 className="text-2xl mb-6">______ ___</h1>
  <div className="relative inline-block ">
    ...
    <div className="relative bg-white text-yellow-600 px-4 py-2 rounded-full font-semibold text-sm flex items-center gap-2">
      ...
      100%
        ...
        <div className="p-2 text-center  mt-[-4px]">
          <p className="text-gray-700 text-xl mb-2 mt-2">All our jewellery is Hallmarked & Certified.</p>
        ...
        <div className="p-6 text-center text-xs text-gray-600">
          ...
          <p>
            Download your certificate from your {' '}
            <a href="/myaccount/profile" className="text-yellow-600 hover:underline font-medium">
              Order details { ' '} 
            </a>
