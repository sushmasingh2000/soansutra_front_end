        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          ...
          <div className="lg:col-span-1 border-b md:border-b-0 border-gray-200 pb-4 md:pb-0">
            ...
            <ul className={`space-y-2 mt-2 ${openSections.caratLaneAdvantage ? 'block' : 'hidden'} md:block`}>
              ...
              <li><a href="/shipping-policy" className="text-gray-600 hover:text-black transition-colors text-sm">Free shipping Policy</a></li>
          ...
          <div className="lg:col-span-1 border-b md:border-b-0 border-gray-200 pb-4 md:pb-0">
            ...
            <ul className={`space-y-2 mt-2 ${openSections.customerService ? 'block' : 'hidden'} md:block`}>
              ...
              <li><a href="/privacy-policy" className="text-gray-600 hover:text-black transition-colors text-sm">Privacy policy</a></li>
              <li><a href="/terms-and-conditions" className="text-gray-600 hover:text-black transition-colors text-sm">Terms and conditions</a></li>
            </ul>
          </div>
              ...
              <div className="mt-4">
                ...
                <div className="space-y-1 text-xs">
                  ...
                  <p class="text-gray-600">
                    Call us on:
                    <a href="tel:7068454247" class="text-black hover:text-gray-800">
                      7068454247
                    </a>
                  </p> {/* Changed to black */}
                </div>
