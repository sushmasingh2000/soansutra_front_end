...
//   const sectionTitleColor = "rgb(79, 50, 103)";
//   const iconColor = "rgb(79, 50, 103)";

//   return (
//     <footer className="py-8 px-4 md:px-6" style={{backgroundColor: 'oklch(97.1% 0.014 343.198)'}}>
...
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Diamond guide</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Jewellery guide</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Gemstones guide</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Gold rate</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Treasure chest</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Glossary</a></li>
//             </ul>
//           </div>
...
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">15-day returns</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Free shipping</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Postcards</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Gold exchange</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">#Wearyourwins</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Gift cards</a></li>
//             </ul>
//           </div>
...
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Return policy</a></li>
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Order status</a></li>
//             </ul>
//           </div>
...
//               <li><a href="#" className="text-gray-600 hover:text-purple-600 transition-colors text-sm">Our story</a></li>
...
//                   <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center mb-1 hover:bg-purple-200 transition-colors cursor-pointer">
...
//               {/* Find A Store Button */}
//               <button className="mt-4 w-full md:w-auto px-4 py-2 border-2 rounded-lg hover:bg-purple-600 hover:text-white transition-all duration-200 font-medium text-sm" style={{border:"1px solid rgb(229, 110, 235)",
//                 color:"rgb(79, 50, 103)"
//               }}>
...
//           <div className="mb-4">
//             <h4 className="text-gray-800 font-medium mb-3 text-sm">Find Us On</h4>
//             <div className="flex space-x-3">
//               <a href="#" className="w-8 h-8 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform" style={{background:"rgb(79, 50, 103)"}}>
...
const Footer = () => {
  ...
  return (
    <footer className="py-8 px-4 md:px-6" style={{backgroundColor: '#FFFFFF'}}> {/* Changed to white */}
      <div className="max-w-7xl mx-auto">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
        ...
        {/* App Download Section */}
        <div className="rounded-xl p-6 mb-5 lg:max-w-md" style={{backgroundColor: '#FFFFFF'}}> {/* Changed to white */}
          <div className="flex flex-col">
            <div className="mb-4">
