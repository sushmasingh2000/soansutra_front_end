...
export const endpoint = {
  ...
  distributor_registration_admin: `${domain}/api/v1/distributor-registration-admin-to-other-id-below`,
  pay_for_subscription_plan_by_admin: `${domain}/api/v1/pay-for-subscription-plan-by-admin`,
